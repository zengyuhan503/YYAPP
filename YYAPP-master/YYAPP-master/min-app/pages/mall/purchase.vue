<template>
	<view class="page-content">
		<view class="paymant-main">
			...
			<view class="address">
				<view class="addr-form">
					...
					<div class="form-box">
						...
						<view class="item">
							<div class="prefix">
								<image src="../../static/icon/icon3.png" style="width: 15px; height: 19px" />
							</div>
							<div class="inputs">
						...
						<view class="item">
							<picker mode="region" @change="bindRegionChange" custom-item="{{customItem}}">
								<div class="prefix" style="left: 15px; top: 10px">
									<image src="../../static/icon/icon2.png" style="width: 28px; height: 28px" />
								</div>
								<div class="inputs">
						...
						<view class="item" style="height: 140px">
							<div class="prefix" style="left: 19px; top: 17px">
								<image src="../../static/icon/icon1.png" style="width: 19px; height: 15px" />
							</div>
							<div class="inputs">
								<textarea name="" id="" v-model="addrForm.address" placeholder="收获地址" cols="30"
			...
			<uni-popup ref="popup" background-color="#fff" type="bottom">
				<view class="slectaddress">
					<view class="title">
						<uni-icons type="left" @click="closePopup" size="30" class="icon" color="#000000">
						</uni-icons>
						选择其他地址
					</view>
					<view class="main">
						<view class="items">
							<view class="item" :class="{ active: addressId == item.id }"
								v-for="(item, index) in addressList" :key="index" @click="handleSelectAddress(item)">
		...
		<view class="pays">
			<view class="price">
				<text style="margin-right: 16px" v-if="goodsInfo.sale_price != goodsInfo.price">折扣价</text>
	...
	<view class="subscribeSuccess" v-if="showSubscribeSuccess">
		<view class="subscribemodal">
			<view class="close">
				<image src="http://h5.dental.cdwuhu.com/static/image/close.png" @click="handleToUser" mode="widthFix" />
			</view>
			<view class="submain">
