<template>
	<view class="page-content page-content2">
		...
		<view class="content">
			<view class="main main1 hasback">
				...
				<view class="imgs imgs">
					<image src="http://h5.dental.cdwuhu.com/static/image/kanzhenyuyue.png" class="kanzhen"
						mode="widthFix"></image>
				</view>
				...
				<view class="popularForm">
					<view class="formInput">
						...
						<input type="text" placeholder="姓名" :disabled="hasSubscribe" v-model="popularForm.name"
							@change="handleChangeFrom" />
					</view>
					<view class="formInput">
						<image src="http://h5.dental.cdwuhu.com/static/image/phone.png" />
						<input type="text" placeholder="手机号" :disabled="hasSubscribe" @change="handleChangeFrom"
					...
					<view class="formGroup">
						<view class="formItem">
							<view class="formInput">
								<view class="genders">
									<view class="boy" :class="{ active: popularForm.gender == 1 }"
										@click="handleChangeGenders('1')">男</view>
									<view class="girl" :class="{ active: popularForm.gender == 0 }"
										@click="handleChangeGenders('0')">女</view>
								</view>
							</view>
						</view>
						<view class="formItem">
							<picker bindchange="bindPickerChange" mode="date" :value="selectror"
								:disabled="hasSubscribe" @change="handleSelectCount">
								<view class="formInput">
									<image style="width: 18px; height: 18px"
										src="http://h5.dental.cdwuhu.com/static/image/age.png" />
									<input type="text" disabled @change="handleChangeFrom" placeholder="年龄"
					...
					<view class="formItem" @click="handleShowPopup">
						<view class="formInput">
							<image style="width: 28px; height: 28px; left: 12px; top: 10px"
								src="http://h5.dental.cdwuhu.com/static/image/addr.png" />
							<input type="text" disabled @change="handleChangeFrom" placeholder="时间"
            ...
            /> -->
					<view v-if="!hasSubscribe">
						...
						<image src="http://h5.dental.cdwuhu.com/static/image/confirm-disable.png" v-else
							mode="widthFix" />
					</view>
					<view v-else>
		...
		<DateElement v-if="showDate" type="1" @handleSelectTimes="handleSelectTimes"
			@handleClosePopup="handleClosePopup" />
	</view>
	<view class="subscribeSuccess" v-if="showSubscribeSuccess">
		<view class="subscribemodal">
			<view class="close">
				<image src="http://h5.dental.cdwuhu.com/static/image/close.png" @click="showSubscribeSuccess = false"
					mode="widthFix" />
			</view>
			<view class="main">
				<image src="http://h5.dental.cdwuhu.com/static/image/subscribe.png" mode="widthFix" />
	...
	<view class="cancelSubcribe" v-if="showCancel">
		<view class="body">
			<view class="close">
				<image src="http://h5.dental.cdwuhu.com/static/image/close.png" @click="showCancel = false"
					mode="widthFix" />
			</view>
			<view class="main">
