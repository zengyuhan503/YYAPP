<template>
	<view class="page-content">
		<view class="detail-status" >
			...
			<view class="timeout" v-if="orderInfo.status==0">请在 <text>00:15:00</text> 内支付</view>
		</view>
		<view class="main">
			<view class="distribution" v-if="orderInfo.status == 2">
				...
				<view class="info">
					<view class="name"> 快递公司： <text>{{orderInfo.ship_company}}</text> </view>
					<view class="phone">
			...
			<view class="commodity">
				...
				<view class="info">
					<view class="cover">
						<image :src="'https://dental.cdwuhu.com/' + orderInfo.goods_image" mode="widthFix" />
					</view>
					<view class="desc">
